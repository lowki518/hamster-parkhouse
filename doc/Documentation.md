...
Part 2: 
   ...
   The work will be distributed similarily to before. 
    ...
    Functions and unit tests finished, CLI done. Cleaning up the final details and working on getting the simulation going. We hate seg faults.
...
-> Nr. 2: Do we even need a reason?! It's f cool!
...
As we mainly met up in person to discuss the progress, most issues were resolved pretty quickly. And when we needed a break, a movie and Ben's cooking usually helped.
